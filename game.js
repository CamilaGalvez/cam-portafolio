...
function create() {
		...
		text2 = game.add.text(5600, 350, '', { font: "130pt Verdana", fill: '#dddddd' });
		...
		text4.alpha = 0.7;		
		text5 = game.add.text(9300, 600, '', { font: "50pt Verdana", fill: '#eeeeee' });
		...
		logolink7 = game.add.sprite(27800, 250, 'logo7');
...
function update () {
	...
	tree.animations.play('tr', 5, true);
